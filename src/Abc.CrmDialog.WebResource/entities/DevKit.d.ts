/** DynamicsCrm.DevKit for namespace CrmDialog */
declare namespace CrmDialog {
    namespace WebApi {
        class AlternateKey {
            /**
...
declare namespace WebApiClient {
     ...
     * @param request the CrmDialog.WebApi.RetrieveRequest object.
     */
    function Retrieve(request: CrmDialog.WebApi.RetrieveRequest): RetrieveResponse;
    /**
     * Retrieves records from CRM (async = false).
     * @param request the CrmDialog.WebApi.RetrieveRequest object.
     */
    function Retrieve(request: CrmDialog.WebApi.RetrieveRequest): void;
    /**
     * Creates a given record in CRM (async = true).
     * @param request The CrmDialog.WebApi.CreateRequest object.
     */
    function Create(request: CrmDialog.WebApi.CreateRequest): CreateResponse;
    /**
     * Creates a given record in CRM (async = false).
     * @param request The CrmDialog.WebApi.CreateRequest object.
     */
    function Create(request: CrmDialog.WebApi.CreateRequest): void;
    /**
     * Updates a given record in CRM (async = true).
     * @param request the CrmDialog.WebApi.UpdateRequest object.
     */
    function Update(request: CrmDialog.WebApi.UpdateRequest): UpdateResponse;
    /**
     * Updates a given record in CRM (async = false).
     * @param request the CrmDialog.WebApi.UpdateRequest object.
     */
    function Update(request: CrmDialog.WebApi.UpdateRequest): void;
    /**
     * Deletes a given record in CRM (async = true).
     * @param request the CrmDialog.WebApi.DeleteRequest object.
     */
    function Delete(request: CrmDialog.WebApi.DeleteRequest): DeleteResponse;
    /**
     * Deletes a given record in CRM (async = false).
     * @param request the CrmDialog.WebApi.DeleteRequest object.
     */
    function Delete(request: CrmDialog.WebApi.DeleteRequest): void;
    /**
     * Associates given records in CRM (async = true).
     * @param request the CrmDialog.WebApi.AssociateRequest object.
     */
    function Associate(request: CrmDialog.WebApi.AssociateRequest): AssociateResponse;
    /**
     * Associates given records in CRM (async = false).
     * @param request the CrmDialog.WebApi.AssociateRequest object.
     */
    function Associate(request: CrmDialog.WebApi.AssociateRequest): void;
    /**
     * Disassociates given records in CRM (async = true).
     * @param request the CrmDialog.WebApi.DisassociateRequest object.
     */
    function Disassociate(request: CrmDialog.WebApi.DisassociateRequest): DisassociateResponse;
    /**
     * Disassociates given records in CRM (async = false).
     * @param request the CrmDialog.WebApi.DisassociateRequest object.
     */
    function Disassociate(request: CrmDialog.WebApi.DisassociateRequest): void;
    /**
