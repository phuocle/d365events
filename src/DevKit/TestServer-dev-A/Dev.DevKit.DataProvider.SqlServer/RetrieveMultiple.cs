...
namespace Dev.DevKit.DataProvider.SqlServer
{
    [CrmPluginRegistration("Dev.DevKit.DataProvider.SqlServer.RetrieveMultiple", "RetrieveMultiple", PluginType.DataProvider, DataSource = "d365vn_sqlserver")]
