...
{
    [CrmPluginRegistration("CalculatePrice", "invoice", StageEnum.PostOperation, ExecutionModeEnum.Asynchronous, "",
    "Dev.DevKit.Plugins.Invoice.PostInvoiceCalculatePriceAsynchronous", 1/*ExecutionOrder*/, IsolationModeEnum.Sandbox, PluginType = PluginType.Plugin, DeleteAsyncOperation = true,
    Image1Name = "", Image1Alias = "", Image1Type = ImageTypeEnum.PreImage, Image1Attributes = "")]
    public class PostInvoiceCalculatePriceAsynchronous : IPlugin
    {
        /*
          InputParameters:
        ...
        */
        ...
        //public PostInvoiceCalculatePriceAsynchronous(string unSecureConfiguration, string secureConfiguration)
        //{
