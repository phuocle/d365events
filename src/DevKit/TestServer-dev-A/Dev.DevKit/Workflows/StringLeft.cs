...
{
    [CrmPluginRegistration("StringLeft", "StringLeft", "", "Dev.DevKit.Workflows", IsolationModeEnum.Sandbox, PluginType = PluginType.Workflow)]
    public class StringLeft : CodeActivity
    {
