...
namespace Dev.DevKit.Workflows
{
    [CrmPluginRegistration("StringUppercase", "StringUppercase", "", "Dev.DevKit.Workflows", IsolationModeEnum.Sandbox, PluginType = PluginType.Workflow)]
    public class StringUppercase : CodeActivity
    {
