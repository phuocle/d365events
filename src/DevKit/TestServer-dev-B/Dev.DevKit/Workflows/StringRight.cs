...
{
    [CrmPluginRegistration("StringRight", "StringRight", "", "Dev.DevKit.Workflows", IsolationModeEnum.Sandbox, PluginType = PluginType.Workflow)]
    public class StringRight : CodeActivity
    {
